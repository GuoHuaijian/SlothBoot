...
<dependency>
    ...
    <artifactId>sloth-boot-starter-mq</artifactId>
...
| `MQHealthIndicator` | RocketMQ 健康检查 |
...
public class OrderCreatedListener extends AbstractMessageListener<OrderMessage> {
    ...
    public OrderCreatedListener(MQProperties mqProperties,
                                ObjectProvider<StringRedisTemplate> redisTemplate) {
        super(mqProperties, redisTemplate);
    }
