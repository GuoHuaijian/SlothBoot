...
import com.sloth.boot.starter.rocketmq.health.RocketMQHealthIndicator;
...
public class RocketMQAutoConfiguration {
    ...
    public MessageProducer messageProducer(RocketMQTemplate rocketMQTemplate, RocketMQProperties mqProperties) {
    ...
    public com.sloth.boot.starter.rocketmq.event.MessageFailureLogListener messageFailureLogListener() {
        return new com.sloth.boot.starter.rocketmq.event.MessageFailureLogListener();
    }
    ...
    public DeadLetterQueueHandler deadLetterQueueHandler(MessageProducer messageProducer, RocketMQProperties mqProperties) {
